...
class GetData():
    ...
    driver.get("https://wibot.work/login")
    ...
    def login(self,username,password):
        ...
        self.driver.find_element(By.ID, 'account').send_keys(username)
        self.driver.find_element(By.ID, 'password').clear()
        self.driver.find_element(By.ID, 'password').send_keys(password)
        self.driver.find_element(By.XPATH, "//button[@class='ant-btn ant-btn-primary ant-btn-lg auth-form-button']").click()

        self.driver.find_element(By.XPATH, "//*[@id='root']/section/header/div/div[1]/ul/li[2]/span").click()       # 服务套件
        self.driver.find_element(By.XPATH, "//*[@id='root']/section/section/aside/div/ul/li[2]/span/span").click()  # 群组管理

    #退出浏览器操作
    def quitDriver(self):
        self.driver.quit()
        # groupName=self.driver.find_elements(By.XPATH,"//*[@id='root']/section/section/main/div[2]/div[2]/div/div/div/div/div/div/div/table/tbody/tr/td[2]/span")
        # memberCount=self.driver.find_elements(By.XPATH,"//*[@id='root']/section/section/main/div[2]/div[2]/div/div/div/div/div/div/div/table/tbody/tr/td[7]/span")
        # company =self.driver.find_element(By.XPATH, "//*[@id='root']/section/header/div/div[2]/div/span[3]")
        # print(company.text)

    def writeData(self, writindex,openSheetName):
        groupName = self.driver.find_elements(By.XPATH, "//*[@id='root']/section/section/main/div[2]/div[2]/div/div/div/div/div/div/div/table/tbody/tr/td[2]/span")
        #memberCount = self.driver.find_elements(By.XPATH,"//*[@id='root']/section/section/main/div[2]/div[2]/div/div/div/div/div/div/div/table/tbody/tr/td[7]/span")
        memberCount = self.driver.find_elements(By.XPATH,"//*[@id='root']/section/section/main/div[2]/div[2]/div/div/div/div/div/div/div/table/tbody/tr/td[6]/span")
        company = self.driver.find_element(By.XPATH, "//*[@id='root']/section/header/div/div[2]/div/span[3]")
        print(company.text)
        # 1、使用xlrd打开Excel
    ...
    def write_Date_index(self,writeSheetName,openSheetName):
        ...
        for index, value in enumerate(firstRowDat):
            if format_now_time == value:
                ...
                print("OK!")
                print(index)
                self.writeData(index,openSheetName)  # 调用写入数据到指定日期的方法
                break
            else:
                continue
...
if __name__ == '__main__':
    # qdcgzs=GetData()
    # qdcgzs.login("admin@QDcgzs.com","Password123")
    # qdcgzs.write_Date_index('12月份企点采购助手','12月份企点采购助手')
    # qdcgzs.quitDriver()

    qdtxgjwl = GetData()
    qdtxgjwl.login("admin@ccbhzzj.com", "Password123")
    qdtxgjwl.write_Date_index('12月建行杭州之江支行','12月建行杭州之江支行')
    qdtxgjwl.quitDriver()
